...
( function( $ ) {
	...
	astra_color_responsive_css( 'transparent-primary-header', 'astra-settings[transparent-submenu-color-responsive]', 'color', '.ast-theme-transparent-header .ast-builder-menu:not( .ast-builder-menu-mobile ) .main-header-menu .sub-menu .menu-item .menu-link,.ast-theme-transparent-header .ast-builder-menu:not( .ast-builder-menu-mobile ) .main-header-menu .sub-menu .menu-item > .ast-menu-toggle, .astra-hfb-header.ast-theme-transparent-header [CLASS*="ast-builder-menu-"]:not( .ast-builder-menu-mobile )  .main-header-menu .sub-menu .menu-item .menu-link, .astra-hfb-header.ast-theme-transparent-header [CLASS*="ast-builder-menu-"]:not( .ast-builder-menu-mobile )  .main-header-menu .sub-menu .menu-item > .ast-menu-toggle' );

	astra_color_responsive_css( 'transparent-primary-header', 'astra-settings[transparent-submenu-h-color-responsive]', 'color', '.ast-theme-transparent-header .ast-builder-menu:not( .ast-builder-menu-mobile ) .main-header-menu .sub-menu a:hover,.ast-theme-transparent-header .ast-builder-menu:not( .ast-builder-menu-mobile ) .main-header-menu .sub-menu .menu-item:hover > .menu-item, .ast-theme-transparent-header .ast-builder-menu:not( .ast-builder-menu-mobile ) .main-header-menu .sub-menu .menu-item.focus > .menu-item, .ast-theme-transparent-header .ast-builder-menu:not( .ast-builder-menu-mobile ) .main-header-menu .sub-menu .menu-item.current-menu-item > .menu-link,	.ast-theme-transparent-header .ast-builder-menu:not( .ast-builder-menu-mobile ) .main-header-menu .sub-menu .menu-item.current-menu-item > .ast-menu-toggle,.ast-theme-transparent-header .ast-builder-menu:not( .ast-builder-menu-mobile ) .main-header-menu .sub-menu .menu-item:hover > .ast-menu-toggle, .ast-theme-transparent-header .ast-builder-menu:not( .ast-builder-menu-mobile ) .main-header-menu .sub-menu .menu-item.focus > .ast-menu-toggle' );
